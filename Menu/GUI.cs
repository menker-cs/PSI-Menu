...
namespace GorillaTagPlugin
{
    ...
    public class GorillaTagGui : BaseUnityPlugin
    {
        ...
        void MainGUI(int windowID)
        {
            ...
            if (GUILayout.Button("Rig", buttonStyle)) currentPage = 2;
            if (GUILayout.Button("Tagging", buttonStyle)) currentPage = 3;
            GUILayout.Space(20);
        ...
        void PlayerPage(GUIStyle buttonStyle)
        {
            ...
            if (GUILayout.Button("Join Random", buttonStyle))
            {
                Debug.Log("Joining random room");
                JoinRandomPublic();
                string customMessage = "Joining random room";
                StartCoroutine(ShowCustomFeedback(customMessage, 3f));
            }
        ...
        void Update()
        {
            ...
            if (isWASDEnabled && isMovementActive)
            {
                WASD();
            }
        ...
        {
            if (GUILayout.Button("Crash All", buttonStyle))
            {
                CrashAll();
            }

            if (GUILayout.Button("Crash Gun", buttonStyle))
            {
                CrashGun();
            }
        }
        ...
        {
            GUILayout.Label("Crash GUn", buttonStyle);
        }
        ...
        void MiscPage(GUIStyle buttonStyle)
        {
            ...
            {
                sidePanelColor = new Color(0.0f, 0.2f, 0.8f);
                buttonColor = new Color(0.0f, 0.2f, 0.8f);
                activeButtonColor = new Color(0.3f, 0.5f, 1.0f);
                buttonTextColor = Color.white;
                mainContentColor = new Color(0.1f, 0.4f, 0.9f);
            }
