...
namespace MenkerMenu.Utilities
{
    public class Variables : MonoBehaviourPunCallbacks
    {
        ...
        // --- UI Colors ---
        public static Color32 BackgroundColor = RoyalBlueTransparent;
        public static Color32 BackToStartButtonColor = Black;
        public static Color32 PageButtonsColor = Black;
        public static Color32 ModEnabledColor = Crimson;
        public static Color32 ModDisabledColor = Black;
        public static Color32 ClickerColor = RoyalBlueTransparent;
        ...
        public static GorillaLocomotion.Player playerInstance;
